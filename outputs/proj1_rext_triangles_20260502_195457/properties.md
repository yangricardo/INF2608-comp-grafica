...
- **seed**: None
- **gamma_fix**: False
- **render_time_seconds**: 497.88388066600237
- **render_time_minutes**: 8.298064677766707
...
- **Throughput**: 48,625 raios/segundo
- **Tempo Estimado**: 534.391s (8.907 min)
- **Tempo Estimado (minutos)**: 8.907
- **Tempo Estimado (interseções)**: 534.391s
...
- **shadow_rays**: 6,500
- **measured_throughput**: 48625 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 534.391s
- **Rays Model (real)**: 497.884s
- **Rays Model (erro abs)**: 36.507s
- **Rays Model (erro rel)**: 7.332%
- **Rays Model (fator real/estimado)**: 0.93x
- **Rays Model (acurácia)**: 92.67%
- **Intersection Model (estimado)**: 534.391s
- **Intersection Model (real)**: 497.884s
- **Intersection Model (erro abs)**: 36.507s
- **Intersection Model (erro rel)**: 7.332%
- **Intersection Model (fator real/estimado)**: 0.93x
- **Intersection Model (acurácia)**: 92.67%
