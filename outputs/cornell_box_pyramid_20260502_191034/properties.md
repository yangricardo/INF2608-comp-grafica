...
- **seed**: None
- **gamma_fix**: False
- **render_time_seconds**: 200.8005515420009
- **render_time_minutes**: 3.3466758590333483

## Estimativa de Raios

- **Raios Primários**: 1,920,000
- **Raios Secundários**: 119,866
- **Shadow Rays**: 1,677,250
- **Total de Raios**: 3,717,116
- **Throughput**: 28,539 raios/segundo
- **Tempo Estimado**: 130.243s (2.171 min)
- **Tempo Estimado (minutos)**: 2.171
- **Tempo Estimado (interseções)**: 130.243s
- **Primary Hit Ratio**: 0.137
...
- **rays_traced**: 1,637
- **intersection_tests**: 32,813
- **shadow_rays**: 1,346
- **measured_throughput**: 28540 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 130.243s
- **Rays Model (real)**: 200.801s
- **Rays Model (erro abs)**: 70.558s
- **Rays Model (erro rel)**: 35.138%
- **Rays Model (fator real/estimado)**: 1.54x
- **Rays Model (acurácia)**: 64.86%
- **Intersection Model (estimado)**: 130.243s
- **Intersection Model (real)**: 200.801s
- **Intersection Model (erro abs)**: 70.558s
- **Intersection Model (erro rel)**: 35.138%
- **Intersection Model (fator real/estimado)**: 1.54x
- **Intersection Model (acurácia)**: 64.86%
