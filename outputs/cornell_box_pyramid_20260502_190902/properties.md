...
- **seed**: None
- **gamma_fix**: False
- **render_time_seconds**: 49.76154291700004
- **render_time_minutes**: 0.8293590486166674

## Estimativa de Raios

- **Raios Primários**: 480,000
- **Raios Secundários**: 29,940
- **Shadow Rays**: 418,923
- **Total de Raios**: 928,863
- **Throughput**: 28,518 raios/segundo
- **Tempo Estimado**: 32.571s (0.543 min)
- **Tempo Estimado (minutos)**: 0.543
- **Tempo Estimado (interseções)**: 32.571s
...
- **samples_tested**: 256
- **rays_traced**: 409
- **intersection_tests**: 8,195
- **shadow_rays**: 336
- **measured_throughput**: 28518 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 32.571s
- **Rays Model (real)**: 49.762s
- **Rays Model (erro abs)**: 17.191s
- **Rays Model (erro rel)**: 34.546%
- **Rays Model (fator real/estimado)**: 1.53x
- **Rays Model (acurácia)**: 65.45%
- **Intersection Model (estimado)**: 32.571s
- **Intersection Model (real)**: 49.762s
- **Intersection Model (erro abs)**: 17.191s
- **Intersection Model (erro rel)**: 34.546%
- **Intersection Model (fator real/estimado)**: 1.53x
- **Intersection Model (acurácia)**: 65.45%
