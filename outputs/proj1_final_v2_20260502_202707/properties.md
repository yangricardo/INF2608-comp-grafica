...
- **seed**: None
- **gamma_fix**: False
- **render_time_seconds**: 172.03947162500117
- **render_time_minutes**: 2.867324527083353

## Estimativa de Raios

- **Raios Primários**: 480,000
- **Raios Secundários**: 77,243
- **Shadow Rays**: 1,424,557
- **Total de Raios**: 1,981,800
- **Throughput**: 26,672 raios/segundo
- **Tempo Estimado**: 74.302s (1.238 min)
- **Tempo Estimado (minutos)**: 1.238
- **Tempo Estimado (interseções)**: 74.302s
- **Primary Hit Ratio**: 0.213
...
- **samples_tested**: 256
- **rays_traced**: 629
- **intersection_tests**: 29,081
- **shadow_rays**: 1,608
- **measured_throughput**: 26672 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 74.302s
- **Rays Model (real)**: 172.039s
- **Rays Model (erro abs)**: 97.738s
- **Rays Model (erro rel)**: 56.811%
- **Rays Model (fator real/estimado)**: 2.32x
- **Rays Model (acurácia)**: 43.19%
- **Intersection Model (estimado)**: 74.302s
- **Intersection Model (real)**: 172.039s
- **Intersection Model (erro abs)**: 97.738s
- **Intersection Model (erro rel)**: 56.811%
- **Intersection Model (fator real/estimado)**: 2.32x
- **Intersection Model (acurácia)**: 43.19%
