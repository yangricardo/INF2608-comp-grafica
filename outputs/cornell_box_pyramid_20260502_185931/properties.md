...
- **seed**: None
- **gamma_fix**: False
- **render_time_seconds**: 50.68103745800181
- **render_time_minutes**: 0.8446839576333635
...
- **Throughput**: 28,345 raios/segundo
- **Tempo Estimado**: 32.769s (0.546 min)
- **Tempo Estimado (minutos)**: 0.546
- **Tempo Estimado (interseções)**: 32.769s
...
- **shadow_rays**: 336
- **measured_throughput**: 28346 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 32.769s
- **Rays Model (real)**: 50.681s
- **Rays Model (erro abs)**: 17.912s
- **Rays Model (erro rel)**: 35.343%
- **Rays Model (fator real/estimado)**: 1.55x
- **Rays Model (acurácia)**: 64.66%
- **Intersection Model (estimado)**: 32.769s
- **Intersection Model (real)**: 50.681s
- **Intersection Model (erro abs)**: 17.912s
- **Intersection Model (erro rel)**: 35.343%
- **Intersection Model (fator real/estimado)**: 1.55x
- **Intersection Model (acurácia)**: 64.66%
