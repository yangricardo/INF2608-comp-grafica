...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 86.56121162501222
- **render_time_minutes**: 1.4426868604168703
...
- **Throughput**: 43,336 raios/segundo
- **Tempo Estimado**: 89.301s (1.488 min)
- **Tempo Estimado (minutos)**: 1.488
- **Tempo Estimado (interseções)**: 89.301s
...
- **shadow_rays**: 1,040
- **measured_throughput**: 43337 raios/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 89.301s
- **Rays Model (real)**: 86.561s
- **Rays Model (erro abs)**: 2.740s
- **Rays Model (erro rel)**: 3.165%
- **Rays Model (fator real/estimado)**: 0.97x
- **Rays Model (acurácia)**: 96.83%
- **Intersection Model (estimado)**: 89.301s
- **Intersection Model (real)**: 86.561s
- **Intersection Model (erro abs)**: 2.740s
- **Intersection Model (erro rel)**: 3.165%
- **Intersection Model (fator real/estimado)**: 0.97x
- **Intersection Model (acurácia)**: 96.83%
