...
- **render_time_seconds**: 231.0282749170001
- **render_time_minutes**: 3.8504712486166683
...
- **Total**: 1,048,576
- **Throughput**: 5,757 caminhos/segundo
- **Tempo Estimado**: 182.136s (3.036 min)
- **Tempo Estimado (minutos)**: 3.036

### Calibração (rápida)
- **elapsed_seconds**: 0.178
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 72,885
- **shadow_rays**: 0
- **measured_throughput**: 5757 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 182.136s
- **Rays Model (real)**: 231.028s
- **Rays Model (erro abs)**: 48.892s
- **Rays Model (erro rel)**: 21.163%
- **Rays Model (fator real/estimado)**: 1.27x
- **Rays Model (acurácia)**: 78.84%
- **Intersection Model (estimado)**: 38.384s
- **Intersection Model (real)**: 231.028s
- **Intersection Model (erro abs)**: 192.644s
- **Intersection Model (erro rel)**: 83.386%
- **Intersection Model (fator real/estimado)**: 6.02x
- **Intersection Model (acurácia)**: 16.61%
