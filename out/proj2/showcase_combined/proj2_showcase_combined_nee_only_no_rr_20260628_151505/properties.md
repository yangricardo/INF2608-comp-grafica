...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --all --spp 2 --depth 4 --no-calibrate
```
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --all --spp 2 --depth 4 --no-calibrate
- **render_time_seconds**: 112.1068317499994
- **render_time_minutes**: 1.8684471958333233
...
- **Rays Model (real)**: 112.107s
- **Rays Model (erro abs)**: 7.249s
- **Rays Model (erro rel)**: 6.466%
- **Rays Model (fator real/estimado)**: 1.07x
- **Rays Model (acurácia)**: 93.53%
