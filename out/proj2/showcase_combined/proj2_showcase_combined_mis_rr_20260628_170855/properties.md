...
- **name**: proj2_showcase_combined_mis_rr
- **width**: 512
- **height**: 512
- **samples_per_pixel**: 4
...
- **render_time_seconds**: 230.761925625
- **render_time_minutes**: 3.84603209375
...
- **Total**: 1,048,576
- **Throughput**: 5,501 caminhos/segundo
- **Tempo Estimado**: 190.615s (3.177 min)
- **Tempo Estimado (minutos)**: 3.177

### Calibração (rápida)
- **elapsed_seconds**: 0.186
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 73,680
- **shadow_rays**: 0
- **measured_throughput**: 5501 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 190.615s
- **Rays Model (real)**: 230.762s
- **Rays Model (erro abs)**: 40.147s
- **Rays Model (erro rel)**: 17.397%
- **Rays Model (fator real/estimado)**: 1.21x
- **Rays Model (acurácia)**: 82.60%
- **Intersection Model (estimado)**: 39.737s
- **Intersection Model (real)**: 230.762s
- **Intersection Model (erro abs)**: 191.025s
- **Intersection Model (erro rel)**: 82.780%
