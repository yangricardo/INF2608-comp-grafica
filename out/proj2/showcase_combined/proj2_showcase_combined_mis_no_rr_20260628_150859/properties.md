...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --spp 4 --depth 12 --mode mis
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --spp 4 --depth 12 --mode mis
- **render_time_seconds**: 402.83531633299935
- **render_time_minutes**: 6.713921938883322
...
- **Total**: 1,048,576
- **Throughput**: 2,785 caminhos/segundo
- **Tempo Estimado**: 376.506s (6.275 min)
- **Tempo Estimado (minutos)**: 6.275

### Calibração (rápida)
- **elapsed_seconds**: 0.368
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 127,125
- **shadow_rays**: 0
- **measured_throughput**: 2785 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 376.506s
- **Rays Model (real)**: 402.835s
- **Rays Model (erro abs)**: 26.329s
- **Rays Model (erro rel)**: 6.536%
- **Rays Model (fator real/estimado)**: 1.07x
- **Rays Model (acurácia)**: 93.46%
- **Intersection Model (estimado)**: 45.492s
- **Intersection Model (real)**: 402.835s
- **Intersection Model (erro abs)**: 357.344s
- **Intersection Model (erro rel)**: 88.707%
- **Intersection Model (fator real/estimado)**: 8.86x
- **Intersection Model (acurácia)**: 11.29%
