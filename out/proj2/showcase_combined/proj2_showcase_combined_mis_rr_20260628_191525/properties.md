...
- **render_time_seconds**: 2173.2264221250007
- **render_time_minutes**: 36.22044036875001
...
- **Total**: 8,388,608
- **Throughput**: 4,864 caminhos/segundo
- **Tempo Estimado**: 1724.537s (28.742 min)
- **Tempo Estimado (minutos)**: 28.742

### Calibração (rápida)
- **elapsed_seconds**: 1.684
- **samples_tested**: 8,192
- **rays_traced**: 0
- **intersection_tests**: 678,735
- **shadow_rays**: 0
- **measured_throughput**: 4864 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1724.537s
- **Rays Model (real)**: 2173.226s
- **Rays Model (erro abs)**: 448.690s
- **Rays Model (erro rel)**: 20.646%
- **Rays Model (fator real/estimado)**: 1.26x
- **Rays Model (acurácia)**: 79.35%
- **Intersection Model (estimado)**: 312.215s
- **Intersection Model (real)**: 2173.226s
- **Intersection Model (erro abs)**: 1861.012s
- **Intersection Model (erro rel)**: 85.634%
- **Intersection Model (fator real/estimado)**: 6.96x
- **Intersection Model (acurácia)**: 14.37%
