...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --all --spp 4 --depth 4
```
...
- **name**: proj2_showcase_combined_nee_only_no_rr
- **width**: 512
- **height**: 512
- **samples_per_pixel**: 4
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --all --spp 4 --depth 4
- **render_time_seconds**: 217.17165995899995
- **render_time_minutes**: 3.6195276659833326

## Estimativa de Caminhos

- **Caminhos Totais**: 1,048,576
- **Bounces Estimados**: 7,340,032 (informativo)
- **Shadow Rays**: 17,616,076
- **Total**: 1,048,576
- **Throughput**: 5,953 caminhos/segundo
- **Tempo Estimado**: 176.140s (2.936 min)
- **Tempo Estimado (minutos)**: 2.936

### Calibração (rápida)
- **elapsed_seconds**: 0.172
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 73,245
- **shadow_rays**: 0
- **measured_throughput**: 5953 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 176.140s
- **Rays Model (real)**: 217.172s
- **Rays Model (erro abs)**: 41.031s
- **Rays Model (erro rel)**: 18.894%
- **Rays Model (fator real/estimado)**: 1.23x
- **Rays Model (acurácia)**: 81.11%
- **Intersection Model (estimado)**: 36.938s
- **Intersection Model (real)**: 217.172s
- **Intersection Model (erro abs)**: 180.234s
- **Intersection Model (erro rel)**: 82.991%
- **Intersection Model (fator real/estimado)**: 5.88x
- **Intersection Model (acurácia)**: 17.01%
