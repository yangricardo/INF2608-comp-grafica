...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --spp 2 --depth 8 --mode mis --no-calibrate
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_combined.py --spp 2 --depth 8 --mode mis --no-calibrate
- **render_time_seconds**: 176.6644180000003
- **render_time_minutes**: 2.9444069666666715

## Estimativa de Caminhos

- **Caminhos Totais**: 524,288
- **Bounces Estimados**: 3,670,016 (informativo)
- **Shadow Rays**: 8,808,038
- **Total**: 524,288
- **Throughput**: 5,000 caminhos/segundo
- **Tempo Estimado**: 104.858s (1.748 min)
- **Tempo Estimado (minutos)**: 1.748

## Qualidade da Estimativa

- **Rays Model (estimado)**: 104.858s
- **Rays Model (real)**: 176.664s
- **Rays Model (erro abs)**: 71.807s
- **Rays Model (erro rel)**: 40.646%
- **Rays Model (fator real/estimado)**: 1.68x
- **Rays Model (acurácia)**: 59.35%
