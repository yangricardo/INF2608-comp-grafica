...
- **render_time_seconds**: 114.46233750000101
- **render_time_minutes**: 1.9077056250000168
...
- **Rays Model (real)**: 114.462s
- **Rays Model (erro abs)**: 9.605s
- **Rays Model (erro rel)**: 8.391%
- **Rays Model (fator real/estimado)**: 1.09x
- **Rays Model (acurácia)**: 91.61%
