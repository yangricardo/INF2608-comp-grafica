...
- **render_time_seconds**: 113.56480874999943
- **render_time_minutes**: 1.8927468124999904
...
- **Rays Model (real)**: 113.565s
- **Rays Model (erro abs)**: 8.707s
- **Rays Model (erro rel)**: 7.667%
- **Rays Model (fator real/estimado)**: 1.08x
- **Rays Model (acurácia)**: 92.33%
