...
- **render_time_seconds**: 2839.0506438340017
- **render_time_minutes**: 47.317510730566696
...
- **Total**: 8,388,608
- **Throughput**: 3,701 caminhos/segundo
- **Tempo Estimado**: 2266.228s (37.770 min)
- **Tempo Estimado (minutos)**: 37.770

### Calibração (rápida)
- **elapsed_seconds**: 2.213
- **samples_tested**: 8,192
- **rays_traced**: 0
- **intersection_tests**: 944,385
- **shadow_rays**: 0
- **measured_throughput**: 3702 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 2266.228s
- **Rays Model (real)**: 2839.051s
- **Rays Model (erro abs)**: 572.823s
- **Rays Model (erro rel)**: 20.177%
- **Rays Model (fator real/estimado)**: 1.25x
- **Rays Model (acurácia)**: 79.82%
- **Intersection Model (estimado)**: 294.873s
- **Intersection Model (real)**: 2839.051s
- **Intersection Model (erro abs)**: 2544.177s
- **Intersection Model (erro rel)**: 89.614%
- **Intersection Model (fator real/estimado)**: 9.63x
- **Intersection Model (acurácia)**: 10.39%
