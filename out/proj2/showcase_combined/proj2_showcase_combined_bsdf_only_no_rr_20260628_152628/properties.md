...
- **render_time_seconds**: 794.7670124169999
- **render_time_minutes**: 13.246116873616666
...
- **Total**: 5,242,880
- **Throughput**: 8,459 caminhos/segundo
- **Tempo Estimado**: 619.757s (10.329 min)
- **Tempo Estimado (minutos)**: 10.329

### Calibração (rápida)
- **elapsed_seconds**: 0.605
- **samples_tested**: 5,120
- **rays_traced**: 0
- **intersection_tests**: 262,830
- **shadow_rays**: 0
- **measured_throughput**: 8460 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 619.757s
- **Rays Model (real)**: 794.767s
- **Rays Model (erro abs)**: 175.010s
- **Rays Model (erro rel)**: 22.020%
- **Rays Model (fator real/estimado)**: 1.28x
- **Rays Model (acurácia)**: 77.98%
- **Intersection Model (estimado)**: 181.096s
- **Intersection Model (real)**: 794.767s
- **Intersection Model (erro abs)**: 613.671s
- **Intersection Model (erro rel)**: 77.214%
- **Intersection Model (fator real/estimado)**: 4.39x
- **Intersection Model (acurácia)**: 22.79%
