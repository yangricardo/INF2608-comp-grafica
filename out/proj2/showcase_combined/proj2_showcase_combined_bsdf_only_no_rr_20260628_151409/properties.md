...
- **render_time_seconds**: 56.04958312499912
- **render_time_minutes**: 0.9341597187499853
...
- **Rays Model (real)**: 56.050s
- **Rays Model (erro abs)**: 48.808s
- **Rays Model (erro rel)**: 87.080%
- **Rays Model (fator real/estimado)**: 0.53x
- **Rays Model (acurácia)**: 12.92%
