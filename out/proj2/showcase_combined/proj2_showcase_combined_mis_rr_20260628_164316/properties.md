...
- **render_time_seconds**: 1357.4406747920002
- **render_time_minutes**: 22.624011246533335
...
- **Total**: 5,242,880
- **Throughput**: 4,745 caminhos/segundo
- **Tempo Estimado**: 1104.787s (18.413 min)
- **Tempo Estimado (minutos)**: 18.413

### Calibração (rápida)
- **elapsed_seconds**: 1.079
- **samples_tested**: 5,120
- **rays_traced**: 0
- **intersection_tests**: 429,075
- **shadow_rays**: 0
- **measured_throughput**: 4746 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1104.787s
- **Rays Model (real)**: 1357.441s
- **Rays Model (erro abs)**: 252.653s
- **Rays Model (erro rel)**: 18.612%
- **Rays Model (fator real/estimado)**: 1.23x
- **Rays Model (acurácia)**: 81.39%
- **Intersection Model (estimado)**: 197.746s
- **Intersection Model (real)**: 1357.441s
- **Intersection Model (erro abs)**: 1159.695s
- **Intersection Model (erro rel)**: 85.432%
- **Intersection Model (fator real/estimado)**: 6.86x
- **Intersection Model (acurácia)**: 14.57%
