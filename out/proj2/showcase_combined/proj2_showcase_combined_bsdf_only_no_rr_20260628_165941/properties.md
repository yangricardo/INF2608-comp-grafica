...
- **render_time_seconds**: 104.54889729199931
- **render_time_minutes**: 1.7424816215333219
...
- **Total**: 1,048,576
- **Throughput**: 12,462 caminhos/segundo
- **Tempo Estimado**: 84.141s (1.402 min)
- **Tempo Estimado (minutos)**: 1.402

### Calibração (rápida)
- **elapsed_seconds**: 0.082
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 34,305
- **shadow_rays**: 0
- **measured_throughput**: 12462 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 84.141s
- **Rays Model (real)**: 104.549s
- **Rays Model (erro abs)**: 20.408s
- **Rays Model (erro rel)**: 19.520%
- **Rays Model (fator real/estimado)**: 1.24x
- **Rays Model (acurácia)**: 80.48%
- **Intersection Model (estimado)**: 37.674s
- **Intersection Model (real)**: 104.549s
- **Intersection Model (erro abs)**: 66.875s
- **Intersection Model (erro rel)**: 63.965%
- **Intersection Model (fator real/estimado)**: 2.78x
- **Intersection Model (acurácia)**: 36.03%
