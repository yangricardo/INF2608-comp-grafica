...
- **render_time_seconds**: 1845.9857741659998
- **render_time_minutes**: 30.76642956943333
...
- **Total**: 5,242,880
- **Throughput**: 3,385 caminhos/segundo
- **Tempo Estimado**: 1548.648s (25.811 min)
- **Tempo Estimado (minutos)**: 25.811

### Calibração (rápida)
- **elapsed_seconds**: 1.512
- **samples_tested**: 5,120
- **rays_traced**: 0
- **intersection_tests**: 639,735
- **shadow_rays**: 0
- **measured_throughput**: 3385 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1548.648s
- **Rays Model (real)**: 1845.986s
- **Rays Model (erro abs)**: 297.338s
- **Rays Model (erro rel)**: 16.107%
- **Rays Model (fator real/estimado)**: 1.19x
- **Rays Model (acurácia)**: 83.89%
- **Intersection Model (estimado)**: 185.915s
- **Intersection Model (real)**: 1845.986s
- **Intersection Model (erro abs)**: 1660.071s
- **Intersection Model (erro rel)**: 89.929%
- **Intersection Model (fator real/estimado)**: 9.93x
- **Intersection Model (acurácia)**: 10.07%
