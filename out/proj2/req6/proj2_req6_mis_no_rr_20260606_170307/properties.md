...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 99.25711920898175
- **render_time_minutes**: 1.6542853201496959
...
- **Rays Model (real)**: 99.257s
- **Rays Model (erro abs)**: 110.458s
- **Rays Model (erro rel)**: 111.285%
- **Rays Model (fator real/estimado)**: 0.47x
