...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 119.4098055830109
- **render_time_minutes**: 1.9901634263835148
...
- **Rays Model (real)**: 119.410s
- **Rays Model (erro abs)**: 90.305s
- **Rays Model (erro rel)**: 75.626%
- **Rays Model (fator real/estimado)**: 0.57x
- **Rays Model (acurácia)**: 24.37%
