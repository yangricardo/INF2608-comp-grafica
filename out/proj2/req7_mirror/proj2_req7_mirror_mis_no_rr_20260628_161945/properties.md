...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_mirror.py --spp 2 --depth 4 --mode mis --no-calibrate
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_mirror.py --spp 2 --depth 4 --mode mis --no-calibrate
- **render_time_seconds**: 43.77344995800013
- **render_time_minutes**: 0.7295574993000021
...
- **Rays Model (real)**: 43.773s
- **Rays Model (erro abs)**: 61.084s
- **Rays Model (erro rel)**: 139.546%
- **Rays Model (fator real/estimado)**: 0.42x
