...
- **render_time_seconds**: 560.7878752079996
- **render_time_minutes**: 9.346464586799993
...
- **Rays Model (real)**: 560.788s
- **Rays Model (erro abs)**: 487.788s
- **Rays Model (erro rel)**: 86.983%
- **Rays Model (fator real/estimado)**: 0.53x
- **Rays Model (acurácia)**: 13.02%
