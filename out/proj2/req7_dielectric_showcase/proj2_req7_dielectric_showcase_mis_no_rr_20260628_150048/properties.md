...
- **render_time_seconds**: 136.31103987500137
- **render_time_minutes**: 2.271850664583356
...
- **Rays Model (real)**: 136.311s
- **Rays Model (erro abs)**: 73.404s
- **Rays Model (erro rel)**: 53.850%
- **Rays Model (fator real/estimado)**: 0.65x
- **Rays Model (acurácia)**: 46.15%
