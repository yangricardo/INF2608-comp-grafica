...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_dielectric_showcase.py --spp 1 --depth 2 --mode mis --no-calibrate
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_dielectric_showcase.py --spp 1 --depth 2 --mode mis --no-calibrate
- **render_time_seconds**: 24.31153458300105
- **render_time_minutes**: 0.4051922430500175

## Estimativa de Caminhos

- **Caminhos Totais**: 262,144
- **Bounces Estimados**: 1,310,720 (informativo)
- **Shadow Rays**: 1,101,004
- **Total**: 262,144
- **Throughput**: 5,000 caminhos/segundo
- **Tempo Estimado**: 52.429s (0.874 min)
- **Tempo Estimado (minutos)**: 0.874

## Qualidade da Estimativa

- **Rays Model (estimado)**: 52.429s
- **Rays Model (real)**: 24.312s
- **Rays Model (erro abs)**: 28.117s
- **Rays Model (erro rel)**: 115.654%
- **Rays Model (fator real/estimado)**: 0.46x
- **Rays Model (acurácia)**: 0.00%
