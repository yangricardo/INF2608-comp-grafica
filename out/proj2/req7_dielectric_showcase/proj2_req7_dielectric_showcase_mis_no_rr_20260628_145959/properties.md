...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_dielectric_showcase.py --spp 16 --depth 20 --mode mis --use-rr 20
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_req7_dielectric_showcase.py --spp 16 --depth 20 --mode mis --use-rr 20
- **render_time_seconds**: 648.9240467089985
- **render_time_minutes**: 10.815400778483308
...
- **Total**: 4,194,304
- **Throughput**: 7,628 caminhos/segundo
- **Tempo Estimado**: 549.802s (9.163 min)
- **Tempo Estimado (minutos)**: 9.163

### Calibração (rápida)
- **elapsed_seconds**: 0.537
- **samples_tested**: 4,096
- **rays_traced**: 0
- **intersection_tests**: 234,930
- **shadow_rays**: 0
- **measured_throughput**: 7629 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 549.802s
- **Rays Model (real)**: 648.924s
- **Rays Model (erro abs)**: 99.123s
- **Rays Model (erro rel)**: 15.275%
- **Rays Model (fator real/estimado)**: 1.18x
- **Rays Model (acurácia)**: 84.73%
- **Intersection Model (estimado)**: 95.858s
- **Intersection Model (real)**: 648.924s
- **Intersection Model (erro abs)**: 553.066s
- **Intersection Model (erro rel)**: 85.228%
- **Intersection Model (fator real/estimado)**: 6.77x
- **Intersection Model (acurácia)**: 14.77%
