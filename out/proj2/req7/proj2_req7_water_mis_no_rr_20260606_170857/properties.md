...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 106.22691558301449
- **render_time_minutes**: 1.7704485930502414
...
- **Rays Model (real)**: 106.227s
- **Rays Model (erro abs)**: 103.488s
- **Rays Model (erro rel)**: 97.422%
- **Rays Model (fator real/estimado)**: 0.51x
- **Rays Model (acurácia)**: 2.58%
