...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 102.22752454102738
- **render_time_minutes**: 1.7037920756837897
...
- **Rays Model (real)**: 102.228s
- **Rays Model (erro abs)**: 107.488s
- **Rays Model (erro rel)**: 105.146%
- **Rays Model (fator real/estimado)**: 0.49x
