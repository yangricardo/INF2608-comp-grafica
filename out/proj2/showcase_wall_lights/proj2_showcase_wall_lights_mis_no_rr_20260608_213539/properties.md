...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 12 --mode mis --use-rr 12
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 12 --mode mis --use-rr 12
- **render_time_seconds**: 377.2453932079952
- **render_time_minutes**: 6.287423220133253
...
- **Total**: 1,048,576
- **Throughput**: 3,035 caminhos/segundo
- **Tempo Estimado**: 345.408s (5.757 min)
- **Tempo Estimado (minutos)**: 5.757

### Calibração (rápida)
- **elapsed_seconds**: 0.337
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 110,110
- **shadow_rays**: 0
- **measured_throughput**: 3036 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 345.408s
- **Rays Model (real)**: 377.245s
- **Rays Model (erro abs)**: 31.837s
- **Rays Model (erro rel)**: 8.439%
- **Rays Model (fator real/estimado)**: 1.09x
- **Rays Model (acurácia)**: 91.56%
- **Intersection Model (estimado)**: 41.759s
- **Intersection Model (real)**: 377.245s
- **Intersection Model (erro abs)**: 335.487s
- **Intersection Model (erro rel)**: 88.931%
- **Intersection Model (fator real/estimado)**: 9.03x
- **Intersection Model (acurácia)**: 11.07%
