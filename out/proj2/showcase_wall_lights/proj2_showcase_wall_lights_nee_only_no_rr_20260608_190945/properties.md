...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode nee_only
```
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode nee_only
- **render_time_seconds**: 213.67307866702322
- **render_time_minutes**: 3.5612179777837203
...
- **Total**: 1,048,576
- **Throughput**: 4,385 caminhos/segundo
- **Tempo Estimado**: 239.103s (3.985 min)
- **Tempo Estimado (minutos)**: 3.985

### Calibração (rápida)
- **elapsed_seconds**: 0.233
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 65,585
- **shadow_rays**: 0
- **measured_throughput**: 4385 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 239.103s
- **Rays Model (real)**: 213.673s
- **Rays Model (erro abs)**: 25.430s
- **Rays Model (erro rel)**: 11.901%
- **Rays Model (fator real/estimado)**: 0.89x
- **Rays Model (acurácia)**: 88.10%
- **Intersection Model (estimado)**: 48.532s
- **Intersection Model (real)**: 213.673s
- **Intersection Model (erro abs)**: 165.142s
- **Intersection Model (erro rel)**: 77.287%
- **Intersection Model (fator real/estimado)**: 4.40x
- **Intersection Model (acurácia)**: 22.71%
