...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode mis
```
...
- **gamma_fix**: False
- **integrator_mode**: mis
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode mis
- **render_time_seconds**: 228.46400158299366
- **render_time_minutes**: 3.807733359716561
...
- **Total**: 1,048,576
- **Throughput**: 5,547 caminhos/segundo
- **Tempo Estimado**: 189.032s (3.151 min)
- **Tempo Estimado (minutos)**: 3.151

### Calibração (rápida)
- **elapsed_seconds**: 0.185
- **samples_tested**: 1,024
- **rays_traced**: 0
- **intersection_tests**: 66,196
- **shadow_rays**: 0
- **measured_throughput**: 5547 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 189.032s
- **Rays Model (real)**: 228.464s
- **Rays Model (erro abs)**: 39.432s
- **Rays Model (erro rel)**: 17.260%
- **Rays Model (fator real/estimado)**: 1.21x
- **Rays Model (acurácia)**: 82.74%
- **Intersection Model (estimado)**: 38.014s
- **Intersection Model (real)**: 228.464s
- **Intersection Model (erro abs)**: 190.450s
- **Intersection Model (erro rel)**: 83.361%
- **Intersection Model (fator real/estimado)**: 6.01x
- **Intersection Model (acurácia)**: 16.64%
