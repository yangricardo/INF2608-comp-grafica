...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 16 --depth 12 --all
```
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 16 --depth 12 --all
- **render_time_seconds**: 1458.2345473330352
- **render_time_minutes**: 24.303909122217252
...
- **Total**: 4,194,304
- **Throughput**: 3,660 caminhos/segundo
- **Tempo Estimado**: 1145.677s (19.095 min)
- **Tempo Estimado (minutos)**: 19.095

### Calibração (rápida)
- **elapsed_seconds**: 1.119
- **samples_tested**: 4,096
- **rays_traced**: 0
- **intersection_tests**: 432,549
- **shadow_rays**: 0
- **measured_throughput**: 3661 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1145.677s
- **Rays Model (real)**: 1458.235s
- **Rays Model (erro abs)**: 312.557s
- **Rays Model (erro rel)**: 21.434%
- **Rays Model (fator real/estimado)**: 1.27x
- **Rays Model (acurácia)**: 78.57%
- **Intersection Model (estimado)**: 141.036s
- **Intersection Model (real)**: 1458.235s
- **Intersection Model (erro abs)**: 1317.198s
- **Intersection Model (erro rel)**: 90.328%
- **Intersection Model (fator real/estimado)**: 10.34x
- **Intersection Model (acurácia)**: 9.67%
