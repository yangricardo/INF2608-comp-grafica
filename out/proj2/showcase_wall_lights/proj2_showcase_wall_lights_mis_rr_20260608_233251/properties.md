...
- **render_time_seconds**: 1088.8697239579633
- **render_time_minutes**: 18.14782873263272
...
- **Total**: 4,194,304
- **Throughput**: 4,396 caminhos/segundo
- **Tempo Estimado**: 954.002s (15.900 min)
- **Tempo Estimado (minutos)**: 15.900

### Calibração (rápida)
- **elapsed_seconds**: 0.932
- **samples_tested**: 4,096
- **rays_traced**: 0
- **intersection_tests**: 302,094
- **shadow_rays**: 0
- **measured_throughput**: 4397 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 954.002s
- **Rays Model (real)**: 1088.870s
- **Rays Model (erro abs)**: 134.868s
- **Rays Model (erro rel)**: 12.386%
- **Rays Model (fator real/estimado)**: 1.14x
- **Rays Model (acurácia)**: 87.61%
- **Intersection Model (estimado)**: 168.155s
- **Intersection Model (real)**: 1088.870s
- **Intersection Model (erro abs)**: 920.714s
- **Intersection Model (erro rel)**: 84.557%
- **Intersection Model (fator real/estimado)**: 6.48x
- **Intersection Model (acurácia)**: 15.44%
