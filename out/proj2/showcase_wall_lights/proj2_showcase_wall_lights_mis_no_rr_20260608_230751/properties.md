...
- **render_time_seconds**: 1498.1306117089698
- **render_time_minutes**: 24.96884352848283
...
- **Total**: 4,194,304
- **Throughput**: 3,574 caminhos/segundo
- **Tempo Estimado**: 1173.531s (19.559 min)
- **Tempo Estimado (minutos)**: 19.559

### Calibração (rápida)
- **elapsed_seconds**: 1.146
- **samples_tested**: 4,096
- **rays_traced**: 0
- **intersection_tests**: 418,379
- **shadow_rays**: 0
- **measured_throughput**: 3574 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1173.531s
- **Rays Model (real)**: 1498.131s
- **Rays Model (erro abs)**: 324.600s
- **Rays Model (erro rel)**: 21.667%
- **Rays Model (fator real/estimado)**: 1.28x
- **Rays Model (acurácia)**: 78.33%
- **Intersection Model (estimado)**: 149.358s
- **Intersection Model (real)**: 1498.131s
- **Intersection Model (erro abs)**: 1348.773s
- **Intersection Model (erro rel)**: 90.030%
- **Intersection Model (fator real/estimado)**: 10.03x
- **Intersection Model (acurácia)**: 9.97%
