...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 64 --depth 12 --all
```
...
- **name**: proj2_showcase_wall_lights_bsdf_only_no_rr
- **width**: 512
- **height**: 512
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 64 --depth 12 --all
- **render_time_seconds**: 2493.4474459999474
- **render_time_minutes**: 41.55745743333246

## Estimativa de Caminhos

- **Caminhos Totais**: 16,777,216
- **Bounces Estimados**: 83,886,080 (informativo)
- **Shadow Rays**: 211,392,921
- **Total**: 16,777,216
- **Throughput**: 9,107 caminhos/segundo
- **Tempo Estimado**: 1842.157s (30.703 min)
- **Tempo Estimado (minutos)**: 30.703

### Calibração (rápida)
- **elapsed_seconds**: 1.799
- **samples_tested**: 16,384
- **rays_traced**: 0
- **intersection_tests**: 701,259
- **shadow_rays**: 0
- **measured_throughput**: 9107 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 1842.157s
- **Rays Model (real)**: 2493.447s
- **Rays Model (erro abs)**: 651.290s
- **Rays Model (erro rel)**: 26.120%
- **Rays Model (fator real/estimado)**: 1.35x
- **Rays Model (acurácia)**: 73.88%
- **Intersection Model (estimado)**: 559.515s
- **Intersection Model (real)**: 2493.447s
- **Intersection Model (erro abs)**: 1933.933s
- **Intersection Model (erro rel)**: 77.561%
- **Intersection Model (fator real/estimado)**: 4.46x
- **Intersection Model (acurácia)**: 22.44%
