...
- **render_time_seconds**: 6107.602802249952
- **render_time_minutes**: 101.7933800374992
...
- **Total**: 16,777,216
- **Throughput**: 3,449 caminhos/segundo
- **Tempo Estimado**: 4863.207s (81.053 min)
- **Tempo Estimado (minutos)**: 81.053

### Calibração (rápida)
- **elapsed_seconds**: 4.749
- **samples_tested**: 16,384
- **rays_traced**: 0
- **intersection_tests**: 1,729,468
- **shadow_rays**: 0
- **measured_throughput**: 3450 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 4863.207s
- **Rays Model (real)**: 6107.603s
- **Rays Model (erro abs)**: 1244.396s
- **Rays Model (erro rel)**: 20.375%
- **Rays Model (fator real/estimado)**: 1.26x
- **Rays Model (acurácia)**: 79.63%
- **Intersection Model (estimado)**: 598.927s
- **Intersection Model (real)**: 6107.603s
- **Intersection Model (erro abs)**: 5508.676s
- **Intersection Model (erro rel)**: 90.194%
- **Intersection Model (fator real/estimado)**: 10.20x
- **Intersection Model (acurácia)**: 9.81%
