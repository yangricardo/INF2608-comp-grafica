...
```bash
/Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode bsdf_only --no-calibrate --seed 42
```
...
- **command_line**: /Users/yang/projects/INF2608-comp-grafica/src/path_tracing/scripts/proj2_showcase_wall_lights.py --spp 4 --depth 4 --mode bsdf_only --no-calibrate --seed 42
- **render_time_seconds**: 107.08715704199858
- **render_time_minutes**: 1.7847859506999764
...
- **Rays Model (real)**: 107.087s
- **Rays Model (erro abs)**: 102.628s
- **Rays Model (erro rel)**: 95.836%
- **Rays Model (fator real/estimado)**: 0.51x
- **Rays Model (acurácia)**: 4.16%
