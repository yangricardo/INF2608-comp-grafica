...
- **name**: proj2_showcase_wall_lights_mis_rr
- **width**: 512
- **height**: 512
...
- **render_time_seconds**: 4182.846928084036
- **render_time_minutes**: 69.71411546806728
...
- **Total**: 16,777,216
- **Throughput**: 4,965 caminhos/segundo
- **Tempo Estimado**: 3378.738s (56.312 min)
- **Tempo Estimado (minutos)**: 56.312

### Calibração (rápida)
- **elapsed_seconds**: 3.300
- **samples_tested**: 16,384
- **rays_traced**: 0
- **intersection_tests**: 1,185,691
- **shadow_rays**: 0
- **measured_throughput**: 4966 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 3378.738s
- **Rays Model (real)**: 4182.847s
- **Rays Model (erro abs)**: 804.109s
- **Rays Model (erro rel)**: 19.224%
- **Rays Model (fator real/estimado)**: 1.24x
- **Rays Model (acurácia)**: 80.78%
- **Intersection Model (estimado)**: 606.941s
- **Intersection Model (real)**: 4182.847s
- **Intersection Model (erro abs)**: 3575.906s
- **Intersection Model (erro rel)**: 85.490%
- **Intersection Model (fator real/estimado)**: 6.89x
- **Intersection Model (acurácia)**: 14.51%
