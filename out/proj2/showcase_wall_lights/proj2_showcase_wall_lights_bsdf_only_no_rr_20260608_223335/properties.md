...
- **render_time_seconds**: 595.9012493750197
- **render_time_minutes**: 9.93168748958366
...
- **Total**: 4,194,304
- **Throughput**: 9,086 caminhos/segundo
- **Tempo Estimado**: 461.595s (7.693 min)
- **Tempo Estimado (minutos)**: 7.693

### Calibração (rápida)
- **elapsed_seconds**: 0.451
- **samples_tested**: 4,096
- **rays_traced**: 0
- **intersection_tests**: 174,876
- **shadow_rays**: 0
- **measured_throughput**: 9087 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 461.595s
- **Rays Model (real)**: 595.901s
- **Rays Model (erro abs)**: 134.307s
- **Rays Model (erro rel)**: 22.538%
- **Rays Model (fator real/estimado)**: 1.29x
- **Rays Model (acurácia)**: 77.46%
- **Intersection Model (estimado)**: 140.551s
- **Intersection Model (real)**: 595.901s
- **Intersection Model (erro abs)**: 455.350s
- **Intersection Model (erro rel)**: 76.414%
- **Intersection Model (fator real/estimado)**: 4.24x
- **Intersection Model (acurácia)**: 23.59%
