...
- **name**: proj2_showcase_wall_lights_nee_only_no_rr
- **width**: 512
- **height**: 512
...
- **render_time_seconds**: 5985.699442249956
- **render_time_minutes**: 99.7616573708326
...
- **Total**: 16,777,216
- **Throughput**: 3,463 caminhos/segundo
- **Tempo Estimado**: 4843.787s (80.730 min)
- **Tempo Estimado (minutos)**: 80.730

### Calibração (rápida)
- **elapsed_seconds**: 4.730
- **samples_tested**: 16,384
- **rays_traced**: 0
- **intersection_tests**: 1,726,153
- **shadow_rays**: 0
- **measured_throughput**: 3464 caminhos/segundo

## Qualidade da Estimativa

- **Rays Model (estimado)**: 4843.787s
- **Rays Model (real)**: 5985.699s
- **Rays Model (erro abs)**: 1141.913s
- **Rays Model (erro rel)**: 19.077%
- **Rays Model (fator real/estimado)**: 1.24x
- **Rays Model (acurácia)**: 80.92%
- **Intersection Model (estimado)**: 597.680s
- **Intersection Model (real)**: 5985.699s
- **Intersection Model (erro abs)**: 5388.019s
- **Intersection Model (erro rel)**: 90.015%
- **Intersection Model (fator real/estimado)**: 10.01x
- **Intersection Model (acurácia)**: 9.99%
