...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 5.086780250014272
- **render_time_minutes**: 0.0847796708335712

## Estimativa de Raios

- **Raios Primários**: 65,536
- **Raios Secundários**: 0
- **Shadow Rays**: 0
- **Total de Raios**: 65,536
- **Throughput**: 35,000 raios/segundo
- **Tempo Estimado**: 1.872s (0.031 min)
- **Tempo Estimado (minutos)**: 0.031
...
- **Rays Model (estimado)**: 1.872s
- **Rays Model (real)**: 5.087s
- **Rays Model (erro abs)**: 3.214s
- **Rays Model (erro rel)**: 63.190%
- **Rays Model (fator real/estimado)**: 2.72x
- **Rays Model (acurácia)**: 36.81%
