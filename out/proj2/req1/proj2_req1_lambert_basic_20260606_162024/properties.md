...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 81.07305983401602
- **render_time_minutes**: 1.351217663900267
...
- **Rays Model (real)**: 81.073s
- **Rays Model (erro abs)**: 128.642s
- **Rays Model (erro rel)**: 158.674%
- **Rays Model (fator real/estimado)**: 0.39x
