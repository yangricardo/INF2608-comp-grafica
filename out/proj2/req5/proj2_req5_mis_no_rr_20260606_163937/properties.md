...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 125.82881408295361
- **render_time_minutes**: 2.09714690138256
...
- **Rays Model (real)**: 125.829s
- **Rays Model (erro abs)**: 83.886s
- **Rays Model (erro rel)**: 66.667%
- **Rays Model (fator real/estimado)**: 0.60x
- **Rays Model (acurácia)**: 33.33%
