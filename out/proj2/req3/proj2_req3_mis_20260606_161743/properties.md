...
- **seed**: 42
- **gamma_fix**: False
- **render_time_seconds**: 119.63047366699902
- **render_time_minutes**: 1.993841227783317
...
- **Rays Model (real)**: 119.630s
- **Rays Model (erro abs)**: 90.085s
- **Rays Model (erro rel)**: 75.302%
- **Rays Model (fator real/estimado)**: 0.57x
- **Rays Model (acurácia)**: 24.70%
