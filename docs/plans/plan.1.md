...
- O relatorio deve separar explicitamente conteudo dos slides de funcionalidades realmente implementadas no repositorio, sobretudo na parte de aceleracao, da modelagem de camera e das convencoes radiometricas adotadas no enunciado.
