#!/usr/bin/env python3
"""Etapa 06: Mesh Lights — Fonte de luz representada por poliedro (malha de triângulos).

Implementa TriangleMeshLight: luz composta por múltiplos triângulos com distribuição
de amostras uniforme de área. Substitui RectAreaLight por uma representação mais
complexa e flexível da geometria de luz.

Uso:
  python -m path_tracing.scripts.proj2_req6_mesh_lights --spp 16 --depth 6 --seed 42 --mode mis
  python -m path_tracing.scripts.proj2_req6_mesh_lights --spp 32 --depth 6 --use-rr true --mode mis
...
if __name__ == '__main__':
  ...
  parser.add_argument('--out', type=str, default='out/proj2/req6', help='Diretório de saída')
  ...
  print('=' * 70)
  print(f'ETAPA 06: Mesh Lights (TriangleMeshLight) — Cornell Box (modo={args.mode})')
  print('=' * 70)
  ...
  scene, camera = build_proj2_cornell_mesh_light_scene()
  ...
  name = f'proj2_req6_{args.mode}{rr_suffix}'
