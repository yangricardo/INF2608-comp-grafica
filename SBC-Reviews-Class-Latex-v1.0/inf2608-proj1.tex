...
\newcommand{\pbrtsec}[1]{PBRT 4e~\citep[Se\c{c}\~ao~#1]{pharr2023pbrt}}
\newcommand{\pbrtsecs}[1]{PBRT 4e~\citep[Se\c{c}\~oes~#1]{pharr2023pbrt}}
...
\title[Projeto 1 de INF2608]{Projeto 1 da disciplina de INF2608 -- Fundamentos de Computação Gráfica: Análise Técnico-Científica de um Ray Tracer Educacional em Alinhamento com os Slides 4--6 e PBRT 4e}
\engtitle{\textcolor{engtitle}{INF2608 Course Project 1 -- Fundamentals of Computer Graphics: Technical-Scientific Analysis of an Educational Ray Tracer Aligned with Lecture Slides 4--6 and PBRT 4e}}
...
\begin{mail}
Trabalho entregue em 10/05/2026 como Projeto 1 da disciplina de INF2608 -- Fundamentos de Computação Gráfica.
\end{mail}
...
Este relatório reconstrói, com prioridade epistemológica explícita, o conteúdo dos Slides 4, 5 e 6 da disciplina~\citep{inf2608slides04,inf2608slides05,inf2608slides06}, usando os resumos em \path{materiais/traçado_de_raios/*.md} apenas como apoio de leitura e o código em \path{src/ray_tracing_2/}, tomado aqui como artefato primário de implementação do repositório do projeto~\citep{inf2608projectrepo}. A documentação em \path{docs/*.md} foi usada apenas como apoio secundário de estrutura e nunca como autoridade teórica principal.

Para separar melhor bibliografia de rastreabilidade interna, os slides da disciplina, PBRT 4e e o repositório do projeto aparecem como referências formais ao longo do texto. Já as menções a arquivos específicos do código seguem a convenção caminho relativo + símbolo + linha, usada apenas como âncora de inspeção local dentro do próprio repositório e não como substituto da bibliografia.
...
Referência complementar em \pbrtsecs{1.2 e 3.5}.
...
Referência complementar em \pbrtsec{1.2}.
...
Referência complementar em \pbrtsec{5.2}.
...
Referência complementar em \pbrtsecs{8.1 e 8.5}.
...
Referência complementar em \pbrtsec{3.5}.
...
Referência complementar em \pbrtsec{12.4}.
...
Referência complementar em \pbrtsec{3.7}.
...
Referência complementar em \pbrtsec{9.3}.
...
Referência complementar em \pbrtsecs{9.3, 9.5 e 11.2}.
...
Referência complementar em \pbrtsec{11.2}.
...
\begin{aitools}
Ferramentas de IA generativa foram utilizadas como apoio à revisão textual, reorganização do conteúdo técnico e conversão inicial do relatório em Markdown para a versão atual em \LaTeX. Todo o conteúdo técnico final foi revisado e validado pelo autor.
\end{aitools}
