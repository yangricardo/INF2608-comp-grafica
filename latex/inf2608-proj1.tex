...
Cobertura integral das referências didáticas e bibliográficas & Não integral & faltam câmera além de pinhole, coerência radiométrica uniforme entre todas as luzes, materiais fisicamente baseados completos e estruturas globais de aceleração \\
\end{tblr}
\end{table*}
...
Esta seção reúne, em formato sintético, os quadros de aderência deslocados das seções analíticas anteriores. Eles devem ser lidos como consolidação comparativa do que já foi discutido no corpo do artigo, em articulação com os slides da disciplina e com as referências selecionadas de \pbrtbook.

\subsection{Núcleo geométrico e fotométrico}

\begin{table*}[!ht]
\caption{Quadro consolidado de aderência entre o núcleo geométrico-fotométrico de referência e a implementação atual.}
...
\begin{table*}[!ht]
\caption{Quadro consolidado de aderência entre as extensões ópticas e amostrais de referência e a implementação atual.}
