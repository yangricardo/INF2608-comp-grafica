...
\caption{Esfera de vidro incolor (IOR=1{,}5), MIS sem RR (800$\times$600, SPP=64, seed=42, $\approx$58 min). A alta reflectância Fresnel em ângulos rasantes --- comportamento correto de \texttt{DielectricBSDF} $\delta$ amostrado estocasticamente --- confere aparência especular às bordas; refração e TIR são observáveis na região central da esfera.}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[width=0.92\linewidth]{../out/proj2/req7/proj2_req7_glass_mis_no_rr_20260606_200923/render.png}
\caption{Esfera de vidro incolor (IOR=1{,}5), MIS sem RR (512$\times$512, SPP=32, $\approx$16 min): resolução intermediária.}
\end{figure}
