...
\noindent\textbf{Variações de parâmetros} (malha com MIS e com Roleta Russa):
\begin{itemize}\small\setlength{\itemsep}{1pt}
\item \texttt{-{}-mode mis -{}-spp 16} --- equivalente à luz retangular de mesma área em alto SPP.
