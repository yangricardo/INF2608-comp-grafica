...
\caption{Vidro incolor (IOR=1{,}5), MIS sem RR (800$\times$600, SPP=64, seed=42, $\approx$58 min): máxima qualidade, evidencia refração, Fresnel e TIR.}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[width=0.92\linewidth]{../out/proj2/req7/proj2_req7_glass_mis_no_rr_20260606_200923/render.png}
\caption{Vidro incolor (IOR=1{,}5), MIS sem RR (512$\times$512, SPP=32, $\approx$16 min): resolução intermediária.}
\end{figure}
...
\figmaybe{../out/proj2/showcase_wall_lights/proj2_showcase_wall_lights_bsdf_only_no_rr.png}{Wall lights --- \texttt{bsdf\_only} (512$\times$512, SPP=64, estratificado, depth=12, $\approx$42 min): alta variância pois as fontes hexagonais laterais são raramente amostradas por BSDF.}
\figmaybe{../out/proj2/showcase_wall_lights/proj2_showcase_wall_lights_nee_only_no_rr.png}{Wall lights --- \texttt{nee\_only} (512$\times$512, SPP=64, estratificado, depth=12, $\approx$100 min): amostragem direta das três fontes (teto + paredes); iluminação direta nítida.}
\figmaybe{../out/proj2/showcase_wall_lights/proj2_showcase_wall_lights_mis_no_rr.png}{Wall lights --- \texttt{mis} (512$\times$512, SPP=64, estratificado, depth=12, $\approx$102 min): combina BSDF e NEE com heurística de potência; menor variância em superfícies difusas e especulares.}
\figmaybe{../out/proj2/showcase_wall_lights/proj2_showcase_wall_lights_mis_rr.png}{Wall lights --- \texttt{mis} + Roleta Russa (512$\times$512, SPP=64, estratificado, depth=12, $\approx$70 min): mesma média com terminação probabilística de caminhos profundos.}
